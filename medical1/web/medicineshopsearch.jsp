...
<head>
    ...
    <title>Medicine Shop Search</title>
    <style>
        body {
...
<body>
    ...
    <div class="login-container">
        <div class="login-box">
            <h1>MEDICINESHOP SEARCH</h1>
            <form method="post">
                <input type="text" name="mci" placeholder="Enter The City" required />
            ...
            <%
                ...
                if (city != null && !city.trim().isEmpty()) {
                    ...
                    try {
                        ...
                        String query = "SELECT * FROM medicineshop WHERE shopCity=?";
                        p = con.prepareStatement(query);
                        p.setString(1, city);
                        r = p.executeQuery();
                        while (r.next()) {
                            String name = r.getString("shopName");
                            String address = r.getString("shopAddress");
                            String city1 = r.getString("shopCity");
                            String contact = r.getString("shopContact");
                            String days = r.getString("shopDays");
                            String hours = r.getString("shopHour");
            %>
                            <div class="result">
