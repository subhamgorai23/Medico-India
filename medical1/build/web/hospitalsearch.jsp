<%-- 
    Document   : hospitalsearch
    Created on : 04-Aug-2024, 8:21:30 pm
    Author     : subhamgorai
--%>
            ...
            <%
                ...
                if (city != null && !city.trim().isEmpty()) {
                    ...
                    try {
                        ...
                        String query = "SELECT * FROM hospital WHERE hcity=?";
                        p = con.prepareStatement(query);
                        p.setString(1, city);
                        r = p.executeQuery();
                        while (r.next()) {
                            String name = r.getString("hname");
                            String address = r.getString("haddress");
                            String city1 = r.getString("hcity");
                            String contact = r.getString("hcontact");
                            String mail = r.getString("hmail");
